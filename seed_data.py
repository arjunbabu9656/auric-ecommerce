...
def seed():
    ...
    for name, slug, cat_slug, price, sale_price, img, featured in products_data:
        p, created = Product.objects.get_or_create(slug=slug, defaults={
            ...
            'description': f'A premium AURIC archival piece. Engineered with technical-grade fabrics and a focus on architectural form. Designed for the modern urban environment.',
    ...
    print("\n✅ Seed complete. All products and categories are live.")
